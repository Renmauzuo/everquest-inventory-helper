...
Tool to help inventory management by parsing an inventory outputfile and displaying a list of which items are used for what.

View this tool [here](https://renmauzuo.github.io/everquest-inventory-helper/)
